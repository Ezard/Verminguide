...
Array.prototype.slice.call(document.getElementsByName("rarity")).forEach(function(b,a,c){b.addEventListener("change",function(){switch(b.id){case "rarity_uncommon":rarity=0;clearTraits(1);break;case "rarity_rare":rarity=1;clearTraits(2);break;case "rarity_exotic":rarity=2;clearTraits(3);break;case "rarity_veteran":setTrait(0,traits[3][0][0],!0),setTrait(1,traits[3][0][1],!0),setTrait(2,traits[3][0][2],!0)}})});
