...
a.name?-1:0});return b}
function updateWeaponStats(a){var b=document.getElementsByClassName("stat_label"),d=document.getElementsByClassName("hbar"),c=document.getElementsByClassName("vbar");if(weapons[a].attacks)for(var e=0;e<weapons[a].attacks.length;e++)b[e].innerHTML=b[e].innerHTML.split(": ")[0]+": "+weapons[a].attacks[e].damage.normal,d[e].style.width=weapons[a].attacks[e].damage.normal/40*100+"%",c[e].style.left="calc("+weapons[a].attacks[e].damage.normal/40*100+"% - 2.5px)";else Array.prototype.slice.call(b).forEach(function(a){a.innerHTML=a.innerHTML.split(": ")[0]+
": 0"}),Array.prototype.slice.call(d).forEach(function(a){a.style.width="0%"}),Array.prototype.slice.call(c).forEach(function(a){a.style.left="-2.5px"})}updateWeaponStats(0);clearTraits(1);
